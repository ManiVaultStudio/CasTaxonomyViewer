...
// // log(data.children.length)
// // log(data.children[0].name)
// // log(data.children[0].children[0].name)
// // log(data.children[0].children[0].children[0].name)
// // log(data.children[0].children[0].children[0].value.toString())
// // log(root.value)
  // // Create the SVG container.
  // const svg = d3.create("svg")
      // .attr("width", width)
    ...
    // log(root.descendants())
    // log(root.descendants().length)
  ...
  // const text = cell.filter(d => (d.x1 - d.x0) > 8).append("text")
